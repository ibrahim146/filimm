...
const Date2020 = () => {
    ...
    useEffect(() => {
        ...
        fetch(`https://api.themoviedb.org/3/search/movie?api_key=b1daa7db24dab8feedb3d1004e6a8a90&language=en-US&query=a&page=1&include_adult=false&year=2020`)
            .then((res) => res.json())
